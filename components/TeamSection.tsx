...
const TeamMember = ({ name, role }: { name: string; role: string }) => (
    <div className="flex flex-col items-center sketch-card p-8 hover:-translate-y-2 transition-transform">
        <div className="w-24 h-24 bg-secondary/20 rounded-full mb-6 flex items-center justify-center border-2 border-primary/20">
        ...
        <section id="team" className="py-24 bg-white/30 relative overflow-hidden border-t-4 border-primary/20">
            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <TeamMember name="Aashritha I." role="Founder" />
                    <TeamMember name="Sadhana S." role="Founder" />
                    <TeamMember name="Srihitha P." role="Founder" />
                </div>
            </div>
        </section>
    );
